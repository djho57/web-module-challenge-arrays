...
function copy(originalFlavors/*your code here*/){
  /*your code here*/
  var clone = originalFlavors.slice();
  return clone;
}    
...
function removeLastFlavor(originalFlavors/*your code here*/){
 /*your code here*/
 originalFlavors.pop();
 return originalFlavors;
}
...
function getFlavorByIndex(originalFlavors,x/*your code here*/){
  /*your code here*/
...
function removeFlavorByName(originalFlavors,x/*your code here*/){
  /*your code here*/
  let y = originalFlavors.indexOf(x);
  originalFlavors.splice(y,1);
  return originalFlavors;
}
...
function filterByWord(originalFlavors,x/*your code here*/){
  /*your code here*/
  let filter = [];
  for (let i = 0; i<originalFlavors.length; i++) {
    if (originalFlavors[i].includes(x)) {
      filter.push(originalFlavors[i]);
    }
  }
  return filter;
}
